(() => {
  ...
  const navItems = [
    ['home', '⌂', 'Главная'], ['search', '⌕', 'Каталог'], ['library', '▦', 'Моё'], ['downloads', '⇩', 'Загрузки'],
  ];
  function addChrome() {
    ...
    root.querySelectorAll('[data-nav]').forEach(button => {
      ...
      button.onclick = () => ({ home, search, library, downloads, settings }[target] || home)();
    });
  }
